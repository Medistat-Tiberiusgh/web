          ...
          {db.loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <KpiCard
                ...
                value={db.latestTrend ? db.latestTrend.totalPatients.toLocaleString() : '—'}
                delta={
                  db.patientsPct != null
                    ? {
                ...
                info={
                  <>
                    <p>
                      Number of unique patients who received at least one dispensing for this drug
                      {db.latestTrend ? ` in ${db.latestTrend.year}` : ''}.
                    </p>
                    <p className="mt-2">
                      National total:{' '}
                      {db.natLatest ? db.natLatest.totalPatients.toLocaleString() : '—'} patients.
                    </p>
                    {db.regLatest && (
                      <p className="mt-2">
                        Total dispensings in {db.regionName ?? 'your region'} ({db.regLatest.year}):{' '}
              ...
              <KpiCard
                ...
                value={db.chronicUseRatio != null ? `${db.chronicUseRatio.toFixed(2)}x` : '—'}
                delta={
          ...
          {!db.activeDrug ? (
            ...
            <>
              ...
              <div className="flex flex-col lg:flex-row gap-3">
                    ...
                    <Card.Content className="p-0">
                      {db.loading ? (
                        ...
                        <DemographicHeatmap
                          ...
                          regionalData={db.filteredRegGrid.length > 0 ? db.filteredRegGrid : undefined}
                          regionName={db.regionName}
                ...
                <div className="flex flex-col gap-3 w-full lg:w-80 xl:w-96 lg:shrink-0">
                  ...
                  <Card>
                      ...
                      <div className="flex flex-col items-start gap-1 pt-0.5 shrink-0 text-[10px]">
                        <div className="flex items-center gap-1.5">
                          <div
                            ...
                            style={{ background: 'linear-gradient(to right, #f1f5f9, #475569)' }}
                          />
                    ...
                    <Card.Content className="pt-3 px-0 pb-0 overflow-hidden" style={{ height: '630px' }}>
                      <MapView
              ...
              <div className="flex gap-3 items-start">
                <div ref={db.chartCardRef} style={{ width: '560px' }} className="shrink-0">
                  <Card>
                    <Card.Header className="flex-row items-start justify-between px-4 pt-4 pb-0">
                      <div>
                        <Card.Title>
